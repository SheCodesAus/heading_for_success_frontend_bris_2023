async function putProgram(id,title, description, goal, image, is_open,is_deleted) {
  const url = `${import.meta.env.VITE_API_URL}/programs/${id}/`;
  ...
  if (!response.ok) {
    const fallbackError = `Error updating program`;
